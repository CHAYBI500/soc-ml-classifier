...
- le pipeline Python `soc_pipeline` (Wazuh → Gemini → GLPI/email/SQLite) sur la VM `Z.Z.Z.Z`.
...
|---|---|
| Wazuh manager | VM Linux — `X.X.X.X` |
| Agent Ubuntu | `A.A.A.A` |
| API ML (FastAPI/uvicorn) | `Z.Z.Z.Z.:8000` |
